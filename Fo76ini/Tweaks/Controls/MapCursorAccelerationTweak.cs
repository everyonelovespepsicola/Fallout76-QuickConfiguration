...
namespace Fo76ini.Tweaks.Controls
{
    class MapCursorAccelerationTweak : ITweak<float>, ITweakInfo
    {
        ...
        public string AffectedValues => "[Client]fMapCursorMoveAcceleration";
        ...
        {
            return IniFiles.GetFloat("Client", "fMapCursorMoveAcceleration", DefaultValue);
        }

        public void SetValue(float value)
        {
            IniFiles.F76Custom.Set("Client", "fMapCursorMoveAcceleration", value);
        }
