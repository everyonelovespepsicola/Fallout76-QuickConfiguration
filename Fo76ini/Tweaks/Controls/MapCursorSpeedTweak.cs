...
namespace Fo76ini.Tweaks.Controls
{
    class MapCursorSpeedTweak : ITweak<float>, ITweakInfo
    {
        ...
        public string AffectedValues => "[Controls]fMapMoveSpeed";
        ...
        {
            return IniFiles.GetFloat("Controls", "fMapMoveSpeed", DefaultValue);
        }

        public void SetValue(float value)
        {
            IniFiles.F76Custom.Set("Controls", "fMapMoveSpeed", value);
        }
